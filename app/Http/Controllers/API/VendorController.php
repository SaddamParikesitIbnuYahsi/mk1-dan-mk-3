 ...
 *     @OA\Property(property="LicenseNumber", type="string", example="LN-12345"),
...
class VendorController extends Controller
{
     ...
     *         response=200,
     *         description="Success",
     *         @OA\JsonContent(type="array", @OA\Items(ref="#/components/schemas/Vendor"))
     *     )
     * )
     */
     ...
     *         @OA\JsonContent(@OA\Property(property="message", type="string", example="Vendor deleted successfully"))
     *     ),
     *     @OA\Response(
     *         response=409,
     *         description="Vendor has existing dependencies",
     *         @OA\JsonContent(@OA\Property(property="message", type="string", example="Failed to delete vendor. It might be associated with existing shipments."))
     *     ),
     *     @OA\Response(
     *         response=500,
     *         description="Server error",
     *         @OA\JsonContent(@OA\Property(property="message", type="string", example="An error occurred while deleting the vendor."))
     *     )
     * )
     */
